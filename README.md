...
**A minimalist, lightning-fast, cinematic screenplay editor built for storytellers.**

## 📖 Description

FADEX is a premium, distraction-free screenwriting workspace designed to keep you in the flow. Built with a high-end, cinematic aesthetic, it combines the power of professional desktop software with the accessibility of the browser. It features a refined design system, intuitive auto-save functionality, and a precise PDF export engine that adheres to industry standards.
